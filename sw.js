...
const APP_SHELL = [
  ...
  'js/services/install-prompt-service.js',
  'js/services/voice-cues-service.js',
  'js/services/exercise-form-service.js',
  'js/services/modules-service.js',
  'js/services/achievements.js',
  'js/services/export-import.js',
  'js/services/notification-service.js',
  'js/services/progress-tracking-service.js',
  'js/services/routine-scheduling-service.js',
  'js/services/image-service.js',
  'js/services/warmup-generator-service.js',
  'js/services/ai-config-service.js',
  'js/services/ai-form-service.js',
  'js/services/workout-timer-service.js',
  'js/services/workout-modals-service.js',
  'js/services/workout-workflow-service.js',
  'js/services/sound-service.js',
  'js/services/exercise-suggestion-service.js',
  // Utils
  'js/utils/helpers.js',
  'js/utils/array.js',
  'js/utils/dom-optimizer.js',
  'js/utils/html-helpers.js',
  ...
  'js/components/ai-feedback-overlay.js',
  // Views
  ...
  'data/ai-exercise-config.json',
  'data/ai-exercise-config-es.json',
