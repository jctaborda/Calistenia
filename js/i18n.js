...
const translations = {
  en: {
    ...
    'settings.font_size_updated': 'Font size updated',
    ...
    // AI Workout
    'ai_not_supported': 'Camera access is not supported in this browser.',
    'ai_form_tracking': 'AI Form Tracking',
    'ai_stop': 'Stop',
    'ai_select_exercise': 'Select Exercise',
    'ai_select_exercise_prompt': 'Choose an exercise to track...',
    'ai_initializing': 'Initializing camera and pose detection...',
    'ai_reps': 'Reps',
    'ai_form_score': 'Form Score',
    'ai_target_reps': 'Target Reps',
    'ai_waiting': 'Waiting for camera...',
    'ai_auto_advance_enabled': 'Auto-advance when target reps reached',
    'ai_info': 'Tips for best results:',
    'ai_info_lighting': 'Ensure good lighting on your body',
    'ai_info_full_body': 'Keep your full body visible in the camera frame',
    'ai_info_contrast': 'Wear contrasting clothing against your background',
    'ai_camera_error': 'Failed to access camera. Please allow camera permissions.',
    'ai_camera_not_allowed': 'Camera permission was denied. Please allow camera access in your browser settings and try again.',
    'ai_camera_not_found': 'No camera found on this device.',
    'ai_camera_in_use': 'Camera is in use by another app. Close other camera apps and try again.',
    'ai_model_load_error': 'AI model failed to load. Check your connection and try again.',
    'ai_start_camera': 'Allow Camera Access',
    'ai_permission_explainer': 'AI form tracking needs camera access to analyze your form in real time.',
    'ai_try_again': 'Try Again',
    'ai_retry': 'Retry',
    'ai_tracking_active': 'Tracking active',
    'ai_tracking_lost': 'Tracking lost - reposition yourself',
    'ai_confidence': 'Confidence',
    'ai_mode': 'AI Mode',
    'ai_start_tracking': 'Start Tracking',
    'ai_stop_tracking': 'Stop Tracking',
    'ai_rep_count': 'Rep {{count}}',
    'ai_target_reached': 'Target reps reached: {{count}}!',
    'toast.ai_reps_completed': 'Target reps reached: {{count}}!',
  },
  es: {
    // Header & Navigation
    ...
    'settings.font_size_updated': 'Tamaño de fuente actualizado',
    ...
    // AI Workout
    'ai_not_supported': 'El acceso a la cámara no es compatible con este navegador.',
    'ai_form_tracking': 'Seguimiento de Forma con IA',
    'ai_stop': 'Detener',
    'ai_select_exercise': 'Seleccionar Ejercicio',
    'ai_select_exercise_prompt': 'Elige un ejercicio para rastrear...',
    'ai_initializing': 'Inicializando cámara y detección de postura...',
    'ai_reps': 'Repeticiones',
    'ai_form_score': 'Puntuación de Forma',
    'ai_target_reps': 'Repeticiones Objetivo',
    'ai_waiting': 'Esperando cámara...',
    'ai_auto_advance_enabled': 'Avanzar automáticamente al alcanzar las repeticiones objetivo',
    'ai_info': 'Consejos para mejores resultados:',
    'ai_info_lighting': 'Asegúrate de tener buena iluminación en tu cuerpo',
    'ai_info_full_body': 'Mantén tu cuerpo completo visible en el encuadre de la cámara',
    'ai_info_contrast': 'Usa ropa de alto contraste con tu fondo',
    'ai_camera_error': 'Error al acceder a la cámara. Por favor permite los permisos de cámara.',
    'ai_camera_not_allowed': 'El permiso de cámara fue denegado. Por favor permite el acceso a la cámara en la configuración de tu navegador e intenta de nuevo.',
    'ai_camera_not_found': 'No se encontró una cámara en este dispositivo.',
    'ai_camera_in_use': 'La cámara está en uso por otra app. Cierra otras aplicaciones de cámara e intenta de nuevo.',
    'ai_model_load_error': 'El modelo de IA no se pudo cargar. Verifica tu conexión e intenta de nuevo.',
    'ai_start_camera': 'Permitir Acceso a Cámara',
    'ai_permission_explainer': 'El seguimiento de forma con IA necesita acceso a la cámara para analizar tu forma en tiempo real.',
    'ai_try_again': 'Intentar de Nuevo',
    'ai_retry': 'Reintentar',
    'ai_tracking_active': 'Seguimiento activo',
    'ai_tracking_lost': 'Seguimiento perdido - reubícate',
    'ai_confidence': 'Confianza',
    'ai_mode': 'Modo IA',
    'ai_start_tracking': 'Iniciar Seguimiento',
    'ai_stop_tracking': 'Detener Seguimiento',
    'ai_rep_count': 'Rep {{count}}',
    'ai_target_reached': '¡Repeticiones objetivo alcanzadas: {{count}}!',
    'toast.ai_reps_completed': '¡Repeticiones objetivo alcanzadas: {{count}}!',
  },
};
